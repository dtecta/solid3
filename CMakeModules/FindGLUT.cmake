...
if (WIN32)
  ...
  find_library( GLUT_DEBUG_LIBRARY NAMES glutd glut32d freeglutd
    PATHS
    ${OPENGL_LIBRARY_DIR}
    ${GLUT_ROOT_PATH}/lib
    ${GLUT_ROOT_PATH}/Release
    )
  if (GLUT_DEBUG_LIBRARY)
    set(GLUT_glut_LIBRARY optimized ${GLUT_LIBRARY} debug ${GLUT_DEBUG_LIBRARY})
  else()
    set(GLUT_glut_LIBRARY ${GLUT_LIBRARY})
  endif()
else ()
